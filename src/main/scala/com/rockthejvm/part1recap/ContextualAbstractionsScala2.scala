...
object ContextualAbstractionsScala2 {
  ...
  // extension method
  val greeting = "Peter".greet() // new PersonableString("Peter").greet()
  ...
  // implicit defs
  implicit def createListSerilalizer[T](implicit serializer: JSONSerializer[T]): JSONSerializer[List[T]] =
